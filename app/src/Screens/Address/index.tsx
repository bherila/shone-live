            ...
            <>
                <View style={styles._viewcard}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <View>
                            <Text style={[item.type === 'Default delivery address' ? null : { color: 'blue' }, styles._texttype]}>{item.type}</Text>
                        ...
                        <Ionicons name='chevron-forward-outline' size={24} color="black" style={{ alignSelf: 'flex-start' }} />
                    </View>
                </View>
                <View style={{ borderWidth: 0.5, marginHorizontal: 10, borderColor: '#DCDCDC' }} />
            </>
        )
    }
            ...
            <Header style={{ elevation: 0, backgroundColor: 'transparent' }}>
                <Left style={{ flex: 1 }}>
                    <Button transparent onPress={() => navigation.goBack()}>
                        <Ionicons name='chevron-back-outline' size={32} color="black" style={{ alignSelf: 'center' }} />
