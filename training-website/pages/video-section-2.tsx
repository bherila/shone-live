      ...
      <div id="root" className="max-w-full overflow-hidden">
        ...
        <main className="relative">
          <section className="relative mt-36">
            <div className="max-w-screen-2xl mx-auto px-2 sm:px-5 xl:px-14 ">
              <div className="flex flex-wrap">
                <div className="w-full lg:w-3/5">
                  <div className="mx-auto object-fit absolute h-full md:h-auto  top-0 flex justify-center md:items-end min-h-xs md:min-h-none">
                    <div className=" flex max-w-5xl mx-auto">
                      <div className="ml-0 relative -top-36 opacity-50 -left-20">
                        <img
                      ...
                      <div className="mr-0 ml-auto relative hidden sm:block -right-10 md:-right-60 lg:-right-20 xl:-right-72 top-16 md:top-0">
                        <img
                          src="hero-bg-right-2.svg"
                          alt="slider"
                          className="md:w-96 md:h-96 h-56 w-56"
                        />
                      </div>
                    </div>
                  </div>

                  <div className="md:pr-20 xl:pr-36">
                    <div className="flex items-center justify-center">
                      <div className="w-auto text-left">
                        <h1 className="xl:text-4xl sm:text-3xl text-2xl font-black leading-none xl:leading-snug  leading-snug   font-playfair">
                          Turn <i>any store</i> into a profitable Live Streaming{' '}
                          <i>extravaganza</i>
                        </h1>
                        <p className="font-light leading-normal py-6  text-lg">
                          Everyone from bakers to candlestick makers is raving
                          about live seller training. We have helped 100s of
                          stores just like you 2x their entire business by
                          successfully selling over video live streams. Join
                          today for Free!
                        </p>
                        <a
                    ...
                    <div className="mt-3">
                      <form>
                        <div className="relative  mx-auto grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="w-full lg:w-2/5 flex">
                  <div className="relative flex w-full z-99 mt-10 lg:mt-0">
                    <div className="bg-gray-300 w-full flex items-center justify-center min-h-xs">
