...
export class SkusService {
    ...
    async create(createSkuDto: CreateSkuDto) {
        ...
        const product = await this.productRepository.findOne({where: {id: createSkuDto.product}});
        const show = await this.showRepository.findOne({where: {id: createSkuDto.show}});
